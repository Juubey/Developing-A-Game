...
public class Spear : MonoBehaviour
{
    ...
    [SerializeField] private SpearLogic spearLogic;
    ...
    void HandleMovement()
    {
        ...
        if (inputData.isPressed == true)
        {
            if (spearLogic.IsWithPlayer())
            {
                ...
                spearLogic.ThrowShield(throwDir);
    ...
    {
        spearLogic.transform.position = m_clickedPos; // position of mouse click
